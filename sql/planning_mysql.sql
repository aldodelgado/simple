...
INSERT INTO `planning_config` VALUES('CURRENT_VERSION', '1.36', 'Internal key for auto upgrade control');
...
CREATE TABLE `planning_projet` (
  ...
  `statut` enum('a_faire','en_cours','fait','abandon','archive') collate latin1_general_ci NOT NULL default 'a_faire',
...
CREATE TABLE `planning_periode` (
  ...
  `modifier_id` VARCHAR( 10 ) CHARACTER SET latin1 COLLATE latin1_general_ci NULL,
...
INSERT INTO `planning_user` VALUES ('ADM', null, 'admin', 'admin', 'df5b909019c9b1659e86e0d6bf8da81d6fa3499e', null, 'oui', '000000', '["users_manage_all", "projects_manage_all", "projectgroups_manage_all", "tasks_modify_all", "tasks_view_all_projects", "parameters_all"]', MD5(RAND()), 'non', NULL, NULL);
