...
<div class="container-fluid">
	...
	-->			
				...
				<select name="couleur" id="couleur" style="background-color:#{$user_form.couleur};color:{"#"|cat:$user_form.couleur|buttonFontColor}" class="jscolor" >
				...
				<span style="width:50px;background-color:{$user_form.couleur}">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
			{else}
				<input id="couleur" type="text" size="7" maxlength="6" value="{$user_form.couleur|escape:"html"}" size="20" maxlength="20" onChange="$S('colorbox').background='#'+this.value;" />
<!--
