			...
			<div class="soplanning-box" style="margin: 0px 10px;">
				<form action="process/planning.php" method="GET" class="form-inline" id="formChoixDates">
					...
					<div class="btn-group" style="margin-left:20px">
						<a class="btn btn-small" onClick="document.location='process/planning.php?raccourci_date=-{$nbJours}';"><i class="icon-backward"></i> {$dateBoutonInferieur}</a>
						<a class="btn btn-small" onClick="document.location='process/planning.php?raccourci_date=+{$nbJours}';">{$dateBoutonSuperieur} <i class="icon-forward"></i></a>
					</div>
		...
		<div class="span12">
			<div class="soplanning-box" style="margin: 10px;">
				<div class="row-fluid">
									...
									<tr>
										<td nowrap="nowrap" valign="top">
											...
											{foreach from=$listeUsers item=userCourant name=loopUsers}
												...
												{/if}
												{if $userCourant.user_groupe_id neq $groupeTemp}
													<input type="checkbox" id="gu{$userCourant.user_groupe_id}" value="1" onClick="filtreCocheUserGroupe('{$userCourant.user_groupe_id}')" /> <label for="gu{$userCourant.user_groupe_id}" style="display:inline"><b>{$userCourant.groupe_nom|escape}</b></label>
												{/if}
												<br />
					...
					<div class="btn-group">
						<button class="btn dropdown-toggle btn-small" data-toggle="dropdown">{#choix_export#}&nbsp;<span class="caret"></span></button>
						<ul class="dropdown-menu">
							<li><a href="javascript:window.print();"><img align="absbottom" border="0" src="assets/img/pictos/printButton.png"> {#printAll#|escape}</a></li>
							<li><a href="export_csv.php"><img align="absbottom" border="0" src="assets/img/pictos/CSVIcon.gif"> {#CSVExport#|escape}</a></li>
							<li><a href="javascript:xajax_choixPDF();undefined;"><img align="absbottom" border="0" src="assets/img/pictos/pdf.png"> {#PDFExport#|escape}</a></li>
							<li><a href="export_gantt.php" target="_blank"><img align="absbottom" border="0" src="assets/img/pictos/gantt.png"> {#ganttExport#|escape}</a></li>
							<li><a href="export_pdf_calendrier.php" target="_blank"><img align="absbottom" border="0" src="assets/img/pictos/calendar.png"> {#calendarExport#|escape}</a></li>
							<li><a href="javascript:xajax_choixIcal();undefined;"><img align="absbottom" border="0" src="assets/img/pictos/ical.png"> {#icalExport#|escape}</a></li>
						</ul>
					</div>
					{* DIV POUR CHOIX DIMENSION CASE ET AFFICHAGE LARGE REDUIT *}
					<div class="btn-group">
						{if $dimensionCase eq "reduit"}
							<a class="btn btn-small" rel="tooltip" title="{#menuPlanningLarge#}" href="process/planning.php?dimensionCase=large"><img align="absbottom" border="0" src="assets/img/pictos/zoomin.png"></a>
						{else}
							<a class="btn btn-small" rel="tooltip" title="{#menuPlanningReduit#}" href="process/planning.php?dimensionCase=reduit"><img align="absbottom" border="0" src="assets/img/pictos/zoomout.png"></a>
						{/if}
						...
						{else}
							<a href="?affichageLarge=0" class="btn btn-small" rel="tooltip" title="{#affichageEtendu#|escape}"><img align="absbottom" border="0" src="assets/img/pictos/scroll.png"></a>
						{/if}
					</div>
