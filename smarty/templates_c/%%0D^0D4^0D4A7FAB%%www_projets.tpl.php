<?php /* Smarty version 2.6.29, created on 2016-06-13 17:27:32
         compiled from www_projets.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'www_projets.tpl', 71, false),array('modifier', 'default', 'www_projets.tpl', 75, false),array('modifier', 'count', 'www_projets.tpl', 91, false),array('modifier', 'xss_protect', 'www_projets.tpl', 142, false),array('modifier', 'cat', 'www_projets.tpl', 157, false),array('modifier', 'buttonFontColor', 'www_projets.tpl', 157, false),array('modifier', 'urlencode', 'www_projets.tpl', 162, false),array('modifier', 'sqldate2userdate', 'www_projets.tpl', 175, false),)), $this); ?>
...
'">
							<td width="25" style="font-size:12px;background-color:#<?php echo $this->_tpl_vars['projet']['couleur']; ?>
...
/assets/img/pictos/edit.gif" border="0" width="16" height="16" align="absbottom" /></a>
									&nbsp;
									<a  href="javascript:xajax_supprimerProjet('<?php echo ((is_array($_tmp=$this->_tpl_vars['projet']['projet_id'])) ? $this->_run_mod_handler('urlencode', true, $_tmp) : urlencode($_tmp)); ?>
');undefined;" onClick="javascript:return confirm('<?php echo ((is_array($_tmp=$this->_config[0]['vars']['projet_liste_confirmSuppr'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'javascript') : smarty_modifier_escape($_tmp, 'javascript')); ?>
')"><img src="<?php echo $this->_tpl_vars['BASE']; ?>
/assets/img/pictos/delete.gif" border="0" width="16" height="16" align="absbottom" /></a>
								<?php endif; ?>
								&nbsp;
...
" alt="<?php echo ((is_array($_tmp=$this->_config[0]['vars']['planning_filtre_sur_projet'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
"><img src="<?php echo $this->_tpl_vars['BASE']; ?>
/assets/img/pictos/logo.png" border="0" width="18" height="18" align="absbottom" /></a>
								&nbsp;
